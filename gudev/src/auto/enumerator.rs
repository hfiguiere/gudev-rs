...
mod sealed {
    pub trait Sealed {}
    impl<T: super::IsA<super::Enumerator>> Sealed for T {}
}

pub trait EnumeratorExt: IsA<Enumerator> + sealed::Sealed + 'static {
    ...
    fn client(&self) -> Option<Client> {
        ObjectExt::property(self.as_ref(), "client")
    }
}
