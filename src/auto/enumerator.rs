...
pub trait EnumeratorExt {
    ...
    fn connect_property_client_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
impl<O: IsA<Enumerator> + IsA<glib::object::Object>> EnumeratorExt for O {
    ...
    fn get_property_client(&self) -> Option<Client> {
        let mut value = Value::from(None::<&Client>);
        unsafe {
...
where P: IsA<Enumerator> {
    ...
    f(&Enumerator::from_glib_none(this).downcast_unchecked())
}
