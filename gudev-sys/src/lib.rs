...
#[repr(C)]
pub struct _GUdevClientPrivate(c_void);
...
#[repr(C)]
pub struct _GUdevDevicePrivate(c_void);
...
#[repr(C)]
pub struct _GUdevEnumeratorPrivate(c_void);
...
extern "C" {
    ...
    pub fn g_udev_device_get_device_file_symlinks(device: *mut GUdevDevice) -> *const *const c_char;
    ...
    pub fn g_udev_device_get_property_as_strv(device: *mut GUdevDevice, key: *const c_char) -> *const *const c_char;
    ...
    pub fn g_udev_device_get_sysfs_attr_as_boolean_uncached(device: *mut GUdevDevice, name: *const c_char) -> gboolean;
    pub fn g_udev_device_get_sysfs_attr_as_double(device: *mut GUdevDevice, name: *const c_char) -> c_double;
    pub fn g_udev_device_get_sysfs_attr_as_double_uncached(device: *mut GUdevDevice, name: *const c_char) -> c_double;
    pub fn g_udev_device_get_sysfs_attr_as_int(device: *mut GUdevDevice, name: *const c_char) -> c_int;
    pub fn g_udev_device_get_sysfs_attr_as_int_uncached(device: *mut GUdevDevice, name: *const c_char) -> c_int;
    pub fn g_udev_device_get_sysfs_attr_as_strv(device: *mut GUdevDevice, name: *const c_char) -> *const *const c_char;
    pub fn g_udev_device_get_sysfs_attr_as_strv_uncached(device: *mut GUdevDevice, name: *const c_char) -> *const *const c_char;
    pub fn g_udev_device_get_sysfs_attr_as_uint64(device: *mut GUdevDevice, name: *const c_char) -> u64;
    pub fn g_udev_device_get_sysfs_attr_as_uint64_uncached(device: *mut GUdevDevice, name: *const c_char) -> u64;
    pub fn g_udev_device_get_sysfs_attr_keys(device: *mut GUdevDevice) -> *const *const c_char;
    pub fn g_udev_device_get_sysfs_attr_uncached(device: *mut GUdevDevice, name: *const c_char) -> *const c_char;
    ...
    pub fn g_udev_device_has_sysfs_attr_uncached(device: *mut GUdevDevice, key: *const c_char) -> gboolean;
